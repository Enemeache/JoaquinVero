    ...
    <section id="contacto" className="bg-[#0a0a0a] py-24 md:py-32 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center md:justify-start mt-2">
              <a
                ...
                className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#1fb859] text-white font-bold text-base px-8 py-4 rounded-xl transition-all duration-200 hover:scale-105 shadow-lg shadow-[#25D366]/25"
              >
          ...
          {/* Right: form — collapsible on mobile */}
          <div>
            {/* Mobile toggle button */}
            <button
              className="md:hidden w-full flex items-center justify-between bg-[#111111] border border-white/10 rounded-2xl px-6 py-4 mb-0 transition-colors hover:border-[#C6FF00]/30"
              onClick={() => setFormOpen((v) => !v)}
            >
              <span className="font-bebas text-xl text-white tracking-wide">DEJAME TU CONSULTA</span>
              <svg
                className={`w-5 h-5 text-[#C6FF00] transition-transform duration-300 ${formOpen ? "rotate-180" : ""}`}
            ...
            <div className={`${formOpen ? "block" : "hidden"} md:block bg-[#111111] border border-white/10 rounded-b-2xl md:rounded-2xl p-8 sm:p-10 border-t-0 md:border-t`}>
              <h3 className="hidden md:block font-bebas text-3xl text-white tracking-wide mb-8">DEJAME TU CONSULTA</h3>
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <textarea
                    placeholder="¿Qué querés lograr? Bajar de peso, ganar masa muscular..."
                    rows={3}
