  ...
  return (
    <section className="bg-[#111111] py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Big Instagram CTA */}
        <div className="relative overflow-hidden rounded-2xl p-10 sm:p-14 mb-16"
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <a href="https://www.instagram.com/joaacoveron/" target="_blank" rel="noopener noreferrer"
              className="flex-shrink-0 flex items-center gap-2 bg-black text-white hover:bg-black/80 font-bold text-sm px-6 py-3.5 rounded-xl transition-all duration-200 hover:scale-105">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {mockPosts.map((post, i) => (
            <a key={i} href="https://www.instagram.com/joaacoveron/" target="_blank" rel="noopener noreferrer"
